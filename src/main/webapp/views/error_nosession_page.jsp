...
<div style="width: 100%; height: 600px;  display: flex; justify-content: center; align-items: center; background-color: #1082d4">
    <div align="center" style="width: 100%; height: 160px; background-color: #fffda0">
        <form style="width: 100%; height: 100%" id="policyholderNosessionForm" action="${pageContext.servletContext.contextPath}/index" method="post">
            <table>
                <tr>
                    <td align="center"><label>Уважаемый страхователь, Вы не авторизованы!<br>
                        Пожалуйста авторизуйтесь или зарегистрируйте новый аккаунт!</label></td>
                </tr>
            </table>
